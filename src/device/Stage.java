...
public class Stage extends Device{
	...
	private void createProperties() {
		sensorState_ = new DeviceProperty(label_, MConfiguration.piproplabel[0], 0, 1,core_,log_,false);
		position_ = new DeviceProperty(label_, MConfiguration.piproplabel[1], 0, 100,core_,log_,false);					/// to check
